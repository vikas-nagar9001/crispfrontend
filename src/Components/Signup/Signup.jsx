...
const Signup = () => {
    ...
    return (
        <>
            <ToastContainer />
            <div className="h-screen bg-[#F7FAFF] w-full py-16 px-4 shadow-2xl ">
                <div className="flex flex-col items-center justify-center ">
                    <div className="bg-white shadow rounded-xl lg:w-[31%]  md:w-1/2 w-full p-10 mt-6">
                        ...
                        <p
                            tabIndex={0}
                            className="flex justify-center focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                            Dont have account?{" "}
                            <a href="#"
                        ...
                        <div>
                            ...
                            <input aria-labelledby="email" placeholder='Email Address' type="email" className="bg-gray-200 border rounded-lg  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        <div className="mt-6  w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input id="pass" placeholder='Password' type="password" className="bg-gray-200 border rounded-lg  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
